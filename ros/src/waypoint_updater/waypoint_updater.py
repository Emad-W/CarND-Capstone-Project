...
CONSTANT_DECEL = 2 / LOOKAHEAD_WPS  # Deceleration constant for smoother braking
PUBLISHING_RATE = 20  # Rate (Hz) of waypoint publishing
STOP_LINE_DISTANCE = 15  # Distance in waypoints to pad in front of the stop line
MAX_DECEL = 1
LOGGING_THROTTLE_FACTOR = 10 #PUBLISHING_RATE * 2  # Only log at this rate (1 / Hz)
...
class WaypointUpdater(object):
	...
	#rospy.logwarn("Publish waypoint")
    ...
    def decelerate_waypoints(self, waypoints, closest_idx):
        ...
        for i, wp in enumerate(waypoints):
            ...
            stop_idx = max(self.stopline_wp_idx - closest_idx - STOP_LINE_DISTANCE, 0)
